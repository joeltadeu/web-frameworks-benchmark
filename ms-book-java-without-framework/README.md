...
```bash
java -jar ms-book-java-without-framework.jar
```
...
to build
```
docker build -f Dockerfile -t ms-book-java-without-framework:1.0.0 .
```

to run as a container
```
docker run -d -p 8080:8080  -i -t ms-book-java-without-framework:1.0.0
```
### Docker Compose
